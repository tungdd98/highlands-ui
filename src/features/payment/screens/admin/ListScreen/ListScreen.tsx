...
const ListScreen: FC = () => {
  ...
  const [queries, setQueries] = useState<PaymentParams>(searchInitialValues);

  useEffect(() => {
    dispatch(getPaymentList(queries)).finally(() => {
      setIsLoading(false);
    ...
    <>
      ...
      >
        ...
        <Button
          ...
          component={Link}
          size="large"
          to={compile(PaymentPathsEnum.EDIT)({
